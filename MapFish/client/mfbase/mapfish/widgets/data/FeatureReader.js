 ...
 *      FeatureReader is a specific Ext.data.DataReader. When records will
 *      be added to the store using this reader, spectific fields like
 *      feature, state and fid will be available.
 *
 * Inherits from:
 *  - {Ext.data.DataReader}
 */
